...
30     G_BL_CLR_IN    G_BL_A_IN      G_BL_CLR_MEM   G_BL_A_MEM   most OPA use this
                ...
                if ('primitive' in data or 'primitiveLodFrac' in data) and (objex_data.write_primitive_color == True):
                ...
                if 'environment' in data and (objex_data.write_environment_color == True):
